...
// export interface Menu {
//     monday_breakfast: string,
//     monday_lunch: string,
//     monday_tea: string,
//     tuesday_breakfast: string,
//     tuesday_lunch: string,
//     tuesday_tea: string,
//     wednesday_breakfast: string,
//     wednesday_lunch: string,
//     wednesday_tea: string,
//     thursday_breakfast: string,
//     thursday_lunch: string,
//     thursday_tea: string,
//     friday_breakfast: string,
//     friday_lunch: string,
//     friday_tea: string,
//     monday_breakfast_veg: string,
//     monday_lunch_veg: string,
//     monday_tea_veg: string,
//     tuesday_breakfast_veg: string,
//     tuesday_lunch_veg: string,
//     tuesday_tea_veg: string,
//     wednesday_breakfast_veg: string,
//     wednesday_lunch_veg: string,
//     wednesday_tea_veg: string,
//     thursday_breakfast_veg: string,
//     thursday_lunch_veg: string,
//     thursday_tea_veg: string,
//     friday_breakfast_veg: string,
//     friday_lunch_veg: string,
//     friday_tea_veg: string
// }
